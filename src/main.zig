...
pub fn main() anyerror!void {
    ...
    } else if (res.args.day == 11) {
        return day11.day11(res.args.input orelse "", res.args.v2 > 0);
    } else if (res.args.day == 12) {
        return day12.day12(res.args.input orelse "", res.args.v2 > 0);
    } else {
